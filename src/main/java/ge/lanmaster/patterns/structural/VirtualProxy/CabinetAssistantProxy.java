 ...
 * @author alexander
 */
public class CabinetAssistantProxy implements CabinetAssistant {
    private CabinetAssistant assistant = null;
     ...
     * not exist.
     */
    private CabinetAssistant getCabinetAssistant() {
        if (assistant == null) {
            try {
                // Get the class object that represents
                // the Assistant class.
                Class clazz;
                clazz = Class.forName("ge.lanmaster.patterns.structural.VirtualProxy.CabinetAssistantImpl");
                ...
                assistant = (CabinetAssistant) constructor.newInstance(actuals);
            } catch (Exception e) {
            } // try
